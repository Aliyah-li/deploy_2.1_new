...
# ============================================================
# fixed_height_simulation/fft_simulation.sh — fixed-height FFT Sim2Sim
# ============================================================
#
# Launches:
...
#
# Usage:
#   ./fixed_height_simulation/fft_simulation.sh [x86|aarch64]
#   RECORD_QPOS_PATH=/tmp/qpos.npz ./fixed_height_simulation/fft_simulation.sh
# ============================================================
...
if command -v ros2 >/dev/null 2>&1; then
  ...
  gnome-terminal --tab --title="RL Deploy (FFT)" -- bash -lc "
    ...
    $ROS_ENV_SETUP;
    source install/setup.bash;
    export POLICY_SUBDIR=fixed_height_fft;
  ...
  echo "  ./fixed_height_simulation/fft_simulation.sh  # already launches MuJoCo"
  echo "  tail -f /tmp/m20_fft_status.log | python3 monitor_ui.py"
  echo ""
  echo "To record qpos:"
  echo "  RECORD_QPOS_PATH=/tmp/qpos.npz ./fixed_height_simulation/fft_simulation.sh"
  echo ""
  echo "Policy: src/M20_sdk_deploy/policy/fixed_height_fft/policy.onnx"
else
