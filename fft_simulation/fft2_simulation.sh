...
# ============================================================
# fft2_simulation.sh — FFT2 (变高度) Sim2Sim Launch Script
# ============================================================
#
# Launches:
...
#   - Single ONNX: policy/fft/policy.onnx
#   - 58-dim obs, 4-dim cmd (vx, vy, heading, height)
#   - 50 Hz control rate
#
# Usage:
#   ./fft_simulation/fft2_simulation.sh [x86|aarch64]
#   RECORD_QPOS_PATH=/tmp/qpos.npz ./fft_simulation/fft2_simulation.sh
# ============================================================
...
if command -v ros2 >/dev/null 2>&1; then
  ...
  echo ""
  echo "Policy: fft/policy.onnx (single ONNX, history VAE)"
  echo "Debug log: /tmp/fft2_debug.log"
  echo ""
  echo "To record qpos:"
  echo "  RECORD_QPOS_PATH=/tmp/qpos.npz ./fft_simulation/fft2_simulation.sh"
else
