...
# ============================================================
# variable_height_simulation/flat_simulation.sh — variable-height flat PPO Sim2Sim
# ============================================================
#
# Launches:
...
#
# Usage:
#   ./variable_height_simulation/flat_simulation.sh [x86|aarch64]
# ============================================================
...
if command -v ros2 >/dev/null 2>&1; then
  ...
  gnome-terminal --tab --title="RL Deploy (Strong2 变高度)" -- bash -lc "
    ...
    export LD_LIBRARY_PATH='$ONNXRUNTIME_LIB':\${LD_LIBRARY_PATH:-};
    export STRONG2_POLICY_SUBDIR=variable_height_flat;
    $ROS_ENV_SETUP;
    source install/setup.bash;
  ...
  echo ""
  echo "Policy: src/M20_sdk_deploy/policy/variable_height_flat/policy.onnx"
